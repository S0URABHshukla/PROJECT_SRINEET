...
function Header() {
  ...
  return (
    <div  className={header.container} >
        <div  style={{color:'#777777', fontSize:''}}> <a style={{textDecoration:'none', color:'#777777'}} href={"./Srineet-Brochure.pdf"}> <span style={{marginRight:'5px'}}><FontAwesomeIcon icon={faFileArrowDown} /></span > Download catalouge</a></div>
